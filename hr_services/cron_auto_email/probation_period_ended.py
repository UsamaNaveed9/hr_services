#CRON Job on 06:00 AM on 22th of each month will run
...
class BuildReport:
	def __init__(self):
		...
		self.report = "Probation Period Ended"
	...
	def get_html_table(self, columns=None, data=None):
		...
		return frappe.render_template(
			...
			{
				"title": "Employees List that Probation Period going to end in the next Month",
				"description": "Please take action accordingly",
				"date_time": date_time,
				"columns": columns,
				"data": data,
...
def send_email():
		...
		for recipient_email in self.email_to:
			frappe.sendmail(
				...
				subject="Employee List those Probation Period will End in the Next Month",
				message=message,
