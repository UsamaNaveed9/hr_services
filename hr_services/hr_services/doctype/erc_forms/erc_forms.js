...
frappe.ui.form.on('ERC Forms', {
	onload(frm){
		if(frm.doc.__islocal){
			...
			frm.toggle_display(['monthly_dedt_amt'], false);
			...
			frm.toggle_display(['deduction_in_months'], false);
			frm.toggle_display(['reason_in_english'], false);
			frm.toggle_display(['reason_in_arabic'], false);
	...
	deduction_in_months(frm){
		if(frm.doc.total_amount){
			frm.set_value("monthly_dedt_amt", frm.doc.total_amount / frm.doc.deduction_in_months);
		}
	}
});
...
function show_fields(frm){
	if(frm.doc.forms == 'Embassy Form'){
		...
		frm.toggle_display(['nationality'], true);
		frm.toggle_display(['national_id_no'], true);
		frm.toggle_display(['monthly_dedt_amt'], true);
		frm.toggle_display(['salutation'], true);
		frm.toggle_display(['deduction_in_months'], true);
		frm.toggle_display(['reason_in_english'], true);
		frm.toggle_display(['reason_in_arabic'], true);
		//hide fields
		frm.toggle_display(['position'], false);
		frm.toggle_display(['basic_salary'], false);
		frm.toggle_display(['housing_allowance'], false);
