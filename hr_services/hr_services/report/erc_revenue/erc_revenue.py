...
def get_columns():
	columns = [
		{"label": _("Project Name"), "fieldname": "project_name", "fieldtype": "Data", "width": 400},
		{"label": _("No of Emps"), "fieldname": "no_of_emps", "fieldtype": "Int", "width": 150},
		{"label": _("ERC Fee"), "fieldname": "erc_fee", "fieldtype": "Data", "width": 130},
		{"label": _("Total Revenue"), "fieldname": "total_revenue", "fieldtype": "Currency", "width": 200},
	]
